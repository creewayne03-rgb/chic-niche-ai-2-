...
.stButton>button{background:linear-gradient(135deg,#7c3aed,#a855f7,#ec4899)!important;color:white!important;border:none!important;border-radius:14px!important;font-weight:700!important;font-size:14px!important;padding:12px 20px!important;width:100%!important;box-shadow:0 4px 20px rgba(124,58,237,0.3)!important;transition:all 0.3s!important;margin-bottom:6px!important}
.stButton>button:hover{transform:translateY(-2px)!important;box-shadow:0 8px 30px rgba(124,58,237,0.5)!important}
.stChatMessage{background:rgba(255,255,255,0.03)!important;border:1px solid rgba(255,255,255,0.07)!important;border-radius:22px!important;padding:1.5rem 2rem!important;margin:12px 0!important}
.stChatMessage p{color:#e2e8f0!important;line-height:1.9!important;font-size:15px!important;margin:0!important}
.stChatInput>div{background:rgba(255,255,255,0.05)!important;border:2px solid rgba(124,58,237,0.4)!important;border-radius:20px!important;padding:6px 10px!important}
...
.stTabs [data-baseweb="tab-list"]{background:rgba(255,255,255,0.04)!important;border-radius:14px!important;padding:4px!important;gap:3px!important;border:1px solid rgba(255,255,255,0.06)!important}
.stTabs [data-baseweb="tab"]{background:transparent!important;color:#64748b!important;border-radius:10px!important;font-size:13px!important;font-weight:700!important;padding:8px 14px!important}
.stTabs [aria-selected="true"]{background:linear-gradient(135deg,#7c3aed,#ec4899)!important;color:white!important}
[data-testid="stFileUploader"]{background:rgba(124,58,237,0.05)!important;border:2px dashed rgba(124,58,237,0.3)!important;border-radius:14px!important;padding:10px!important}
...
.stTextInput input{background:rgba(255,255,255,0.05)!important;border:1.5px solid rgba(124,58,237,0.3)!important;border-radius:12px!important;color:white!important;font-size:15px!important;padding:12px 16px!important}
.stTextInput input::placeholder{color:#334155!important}
.streamlit-expanderHeader{background:rgba(124,58,237,0.08)!important;border:1.5px solid rgba(124,58,237,0.2)!important;border-radius:16px!important;color:#a78bfa!important;font-size:15px!important;font-weight:700!important;padding:14px 18px!important}
.streamlit-expanderContent{background:rgba(255,255,255,0.02)!important;border:1px solid rgba(255,255,255,0.05)!important;border-top:none!important;border-radius:0 0 16px 16px!important;padding:20px!important}
...
""", unsafe_allow_html=True)
    ...
    with t1:
        st.markdown("<p style='font-size:12px;color:#475569;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:10px'>Upload Documents</p>",unsafe_allow_html=True)
    ...
    with t2:
        st.markdown("<p style='font-size:12px;color:#475569;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:10px'>Visual Intelligence</p>",unsafe_allow_html=True)
        st.markdown("<p style='font-size:14px;color:#94a3b8;margin-bottom:14px;line-height:1.8'>Upload an image or take a photo. I will analyze everything I see.</p>",unsafe_allow_html=True)
    ...
    with t3:
        st.markdown("<p style='font-size:12px;color:#475569;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;margin-bottom:10px'>Voice Input</p>",unsafe_allow_html=True)
        st.markdown("<p style='font-size:14px;color:#94a3b8;margin-bottom:14px;line-height:1.8'>Record your voice. I will transcribe and respond to you.</p>",unsafe_allow_html=True)
...
<div style='text-align:center;padding:16px 0'>
    ...
    <p style='font-size:13px;color:#475569;margin-bottom:20px;line-height:1.7'>Restricted to Wayne Wanjohi only.</p>
</div>
""", unsafe_allow_html=True)
            pwd=st.text_input("",type="password",placeholder="Enter admin password...",label_visibility="collapsed")
...
<div style='margin-top:28px;padding-top:18px;border-top:1px solid rgba(255,255,255,0.06);text-align:center'>
    <div style='font-size:11px;color:#1e293b;line-height:2.2'>
        2026 Wayne Wanjohi<br>Chic Niche AI<br>All rights reserved<br>
        <span style='font-size:10px;color:#0f172a'>Version 4.0.0 Premium</span>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div style='background:linear-gradient(135deg,rgba(245,158,11,0.1),rgba(251,191,36,0.05));border:1px solid rgba(245,158,11,0.25);border-radius:20px;padding:20px 28px;margin-bottom:24px;display:flex;align-items:center;gap:16px;animation:fadeIn 0.5s ease'>
    ...
    <div>
        ...
        <div style='font-size:13px;color:#92400e;line-height:1.6'>Private mode active. Speak freely about business strategy, plans and confidential matters.</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div style='text-align:center;padding:40px 0 28px;animation:fadeIn 0.8s ease'>
    ...
    <div style='display:flex;justify-content:center;flex-wrap:wrap;gap:9px'>
        ...
        <span style='background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.22);border-radius:20px;padding:6px 16px;font-size:13px;color:#fbbf24;font-weight:600'>🔐 Private Admin</span>
    </div>
</div>
...
<div style='background:linear-gradient(135deg,rgba(245,158,11,0.08),rgba(251,191,36,0.04));border:1px solid rgba(245,158,11,0.16);border-radius:28px;padding:44px;text-align:center;margin-bottom:32px;animation:fadeIn 0.6s ease'>
    ...
    <p style='color:#92400e;font-size:16px;line-height:2;margin:0 auto;max-width:520px'>
...
with st.expander("➕   Attach Files, Photos or Voice", expanded=False):
    st.markdown("<p style='font-size:15px;color:#64748b;margin-bottom:20px;line-height:1.9'>Attach documents, photos or record a voice message before sending.</p>",unsafe_allow_html=True)
    col_a,col_b,col_c=st.columns(3)
    with col_a:
        st.markdown("<p style='font-size:14px;color:#a78bfa;font-weight:700;margin-bottom:10px'>📄 Document</p>",unsafe_allow_html=True)
    ...
    with col_b:
        st.markdown("<p style='font-size:14px;color:#ec4899;font-weight:700;margin-bottom:10px'>📸 Photo</p>",unsafe_allow_html=True)
    ...
    with col_c:
        st.markdown("<p style='font-size:14px;color:#34d399;font-weight:700;margin-bottom:10px'>🎤 Voice</p>",unsafe_allow_html=True)
